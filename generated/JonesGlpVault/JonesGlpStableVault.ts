...
export class JonesGlpStableVault extends ethereum.SmartContract {
  static bind(address: Address): JonesGlpStableVault {
    return new JonesGlpStableVault("JonesGlpStableVault", address);
  }
