...
export class GlpManager__getGlobalShortDeltaResult {
  value0: BigInt;
  value1: boolean;
...
export class GlpManager extends ethereum.SmartContract {
  ...
  GLP_PRECISION(): BigInt {
    let result = super.call("GLP_PRECISION", "GLP_PRECISION():(uint256)", []);

    return result[0].toBigInt();
  }

  try_GLP_PRECISION(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "GLP_PRECISION",
      "GLP_PRECISION():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getGlobalShortDelta(
    ...
    _price: BigInt,
    _size: BigInt
  ): GlpManager__getGlobalShortDeltaResult {
    let result = super.call(
      "getGlobalShortDelta",
    ...
    return new GlpManager__getGlobalShortDeltaResult(
      result[0].toBigInt(),
      result[1].toBoolean()
    );
  }
  ...
  try_getGlobalShortDelta(
    ...
    _price: BigInt,
    _size: BigInt
  ): ethereum.CallResult<GlpManager__getGlobalShortDeltaResult> {
    let result = super.tryCall(
      "getGlobalShortDelta",
      "getGlobalShortDelta(address,uint256,uint256):(uint256,bool)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new GlpManager__getGlobalShortDeltaResult(
        value[0].toBigInt(),
        value[1].toBoolean()
      )
    );
